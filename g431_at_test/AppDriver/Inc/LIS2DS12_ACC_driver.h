...
#define LIS2DS12_ACC_I2C_ADDRESS_HIGH         0x3B
...
typedef enum {
	CFN_SUCCESS							=		0x00,
  CFN_HARD_WARE_ERROR			=		0x01,	//硬件故障
  CFN_READ_ID_ERROR				=		0x02,	//读数据失败
	CFN_MODEL_ERROR					=		0x03,	//传感器型号不匹配
	
	CFN_CTRL1_INIT_ERROR		=		0x04,	//CTRL1 初始化失败
	CFN_CTRL2_INIT_ERROR		=		0x05,	//CTRL2 初始化失败
	
	CFN_DRDY								=		0x06,	//准备数据中
	CFN_READ_DATA_ERROR			=		0x07	//数据采集失败
} cfn_status_t;
