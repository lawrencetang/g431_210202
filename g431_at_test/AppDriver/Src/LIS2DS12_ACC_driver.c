...
cfn_status_t cfn_stat = CFN_SUCCESS;
...
* Return			: None
*******************************************************************************/
status_t LIS2DS12_ACC_WriteReg(void *handle, u8_t Reg, u8_t *Bufp, u16_t len)
{
  ...
  //             Bufp, len, 1000); 
	...
	status = HAL_I2C_Mem_Write(handle, LIS2DS12_ACC_I2C_ADDRESS_HIGH & 0xFE, Reg, 1, Bufp, len, 100);
	if(HAL_OK != status)
	{
		//I2C写数据错误
		return MEMS_ERROR;
...
* Return			: None
*******************************************************************************/
status_t LIS2DS12_ACC_ReadReg(void *handle, u8_t Reg, u8_t *Bufp, u16_t len)
{
  //To be completed with either I2c or SPI writing function
  ...
  /* Added by HugeD at 2021-1-21 *BEGIN* */
	...
	status = HAL_I2C_Mem_Read(handle, LIS2DS12_ACC_I2C_ADDRESS_HIGH, Reg, 1, Bufp, len, 100);
	if(HAL_OK != status)
	{
		//I2C读数据错误
		return MEMS_ERROR;
...
*******************************************************************************/
status_t LIS2DS12_ACC_R_WHO_AM_I_BIT(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_WHO_AM_I_REG, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_CTRL1, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_Get_Raw_Acceleration(void *handle, u8_t *buff)
{
...
/*******************************************************************************
* Function Name  : status_t LIS2DS12_ACC_Get_Acceleration(void *handle, int *buff, u8_t from_fifo)
 ...
 */
status_t LIS2DS12_ACC_Get_Acceleration(void *handle, i16_t *buff)
{
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_MODULE8_BIT(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_MODULE_8BIT, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_CTRL2, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
status_t LIS2DS12_ACC_R_FUNC_CFG(void *handle, LIS2DS12_ACC_FUNC_CFG_t *value)
{
  ...
  *value &= LIS2DS12_ACC_FUNC_CFG_MASK; //mask
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_CTRL3, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_CTRL4, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
status_t LIS2DS12_ACC_R_INT1_D_TAP(void *handle, LIS2DS12_ACC_INT1_D_TAP_t *value)
{
  ...
  *value &= LIS2DS12_ACC_INT1_D_TAP_MASK; //mask
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_CTRL5, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FIFO_CTRL, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_Temperature(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_OUT_T, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_STATUS, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_FifoThsld(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_FifoThsld(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FIFO_THS, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FIFO_SRC, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_SamplesNum(void *handle, u16_t *value)
{
  u8_t valueH, valueL;

  /* Low part */
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FIFO_SAMPLES, (u8_t *)&valueL, 1) )
    return MEMS_ERROR;
  ...
  /* High part */
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FIFO_SRC, (u8_t *)&valueH, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_TAP_THS(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_TAP_THS(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_TAP_6D_THS, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_SHOCK(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_SHOCK(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_INT_DUR, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_QUIET(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_QUIET(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_INT_DUR, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_LAT(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_LAT(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_INT_DUR, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_WU_THS(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_WU_THS(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_WAKE_UP_THS, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_SleepDuration(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_SleepDuration(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_WAKE_UP_DUR, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_WakeUpDuration(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_WakeUpDuration(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_WAKE_UP_DUR, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_FreeFallThreshold(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_FreeFallThreshold(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FREE_FALL, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_FreeFallDuration(void *handle, u8_t newValue)
{
  u8_t valueH, valueL;
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_FreeFallDuration(void *handle, u8_t *value)
{
  u8_t value_tmp;

 /* Low part */
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FREE_FALL, (u8_t *)&value_tmp, 1) )
    return MEMS_ERROR;
 ...
 /* High part */
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_WAKE_UP_DUR, (u8_t *)&value_tmp, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_STATUS_DUP, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_WAKE_UP_SRC, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_TAP_SRC, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_6D_SRC, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LIS2DS12_ACC_W_SC_MTHS(void *handle, u8_t newValue)
{
  u8_t value;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_R_SC_MTHS(void *handle, u8_t *value)
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_STEP_C_MINTHS, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FUNC_CK_GATE, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FUNC_SRC, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
{
 if( !LIS2DS12_ACC_ReadReg(handle, LIS2DS12_ACC_FUNC_CTRL, (u8_t *)value, 1) )
    return MEMS_ERROR;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_Get_ExternalSensor(void *handle, u8_t *buff) 
{
  u8_t i, j, k;
...
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t LIS2DS12_ACC_Get_StepCounter(void *handle, u8_t *buff) 
{
  u8_t i, j, k;
  u8_t numberOfByteForDimension;
