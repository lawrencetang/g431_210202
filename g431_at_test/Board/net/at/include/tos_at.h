...
#define AT_DATA_CHANNEL_FIFO_BUFFER_SIZE        (2048)   //ltg(2048 + 1024)

#define AT_UART_RX_FIFO_BUFFER_SIZE             (2048)  //ltg(2048 + 1024)
#define AT_RECV_CACHE_SIZE                      2048   //ltg 2048

#define AT_CMD_BUFFER_SIZE                      512

#define AT_PARSER_TASK_STACK_SIZE               2048   //ltg 2048
